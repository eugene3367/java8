...
public class Member {
	...
	//기본 생성자(Constructor)로서 선언하지 않아도 자동으로 자바가 생성자를묵시적으로 선언함
	public Member() {}
	...
	//접근제한자 반환타입 메서드명([매개변수 매개변수명,...]){return 반환변수명|값;}
	//접근제한자 void 메서드명([매개변수 매개변수명,...]){실행문;}
	
	public String getId() {		//클래스의 멤버 메서드
		return id;
	}
