...
public class OuterClass {	//외부 클래스
	...
	public void method1(){
		System.out.println("외부 클래스");	//멤버 메소드
	}
	...
	class Inner{
		...
		public void method1(){
			System.out.println("내부 클래스");	//내부 클래스의 멤버 메소드
		}
	...
	static class Inner2{
		...
		public void method1(){
			System.out.println("내부 정적 클래스");	//정적 내부 (멤버)클래스의 멤버 메소드
		}
		static public void method2(){
			System.out.println("내부 정적 클래스");	//내부 정적 클래스의 멤버 메소드
		}
	}
